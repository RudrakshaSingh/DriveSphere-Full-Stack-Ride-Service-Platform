...
const LookingForDriver = (props) => {
	...
	return (
		<div className="relative bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-auto">
			...
			<h3 className="text-2xl font-semibold text-center mt-10 mb-6">Looking for a Driver</h3>
			...
			<div className="relative h-32 mb-6 overflow-hidden rounded-lg bg-gradient-to-b from-gray-800 to-gray-600">
				...
				<div className="absolute bottom-8 drive-animation">
					<img src={vehicleImg} alt="Vehicle" className="h-16 object-contain" />
				</div>
			</div>
					...
					<div>
						...
						{props.couponResponse !== "" ? (
							<div className="flex items-center gap-2">
								<p className="text-sm text-gray-600 line-through">₹{props.fare[props.vehicleType]}</p>
