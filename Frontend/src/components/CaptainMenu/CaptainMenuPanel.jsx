...
function CaptainMenuPanel({ openCaptainMenu, toggleCaptainMenu }) {
  ...
  return (
	<>
	  ...
	  ${openCaptainMenu ? "translate-x-0" : "-translate-x-full"}
	`}>
		{/* Header with logo */}
		<div className="bg-gradient-to-r from-indigo-500 to-purple-500 p-6">
		  <div className="flex items-center justify-between mb-4">
			<img src={logo} alt="Logo" className="h-8 w-auto" />
			<button onClick={toggleCaptainMenu} className="p-2 hover:bg-white/10 rounded-full transition-colors">
...
export default CaptainMenuPanel