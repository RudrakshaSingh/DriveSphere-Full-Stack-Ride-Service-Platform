...
function UserLogin() {
  ...
  return (
    <div className="p-7 flex flex-col justify-between h-screen">
      ...
      <div>
        <Link to={'/captain-login'} className="bg-[#58a981] flex items-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 border w-full text-lg placeholder:text-base">
          Sign in as Captain
        </Link>
      </div>
    </div>
